...
export const ModelTypeSchema = z.enum(
  ...
  {
    required_error:
      'Model Name is required: gpt-4 | gpt-4o | gpt-4-0613 | gpt-4-32k | gpt-4-32k-0613 | gpt-3.5-turbo | gpt-3.5-turbo-16k | gpt-3.5-turbo-0613 | gpt-3.5-turbo-16k-0613',
    invalid_type_error: 'Invalid model name: gpt-4 | gpt-4o | gpt-4-0613 | gpt-4-32k | gpt-4-32k-0613 | gpt-3.5-turbo | gpt-3.5-turbo-16k | gpt-3.5-turbo-0613 | gpt-3.5-turbo-16k-0613'
  }
);
